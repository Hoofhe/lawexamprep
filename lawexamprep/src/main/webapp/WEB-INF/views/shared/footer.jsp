			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 footer-widget">
					<div class="about-widget">
						...
						<p>Your success partner. Any writeup.</p>
				...
				<div class="col-sm-6 col-lg-3 footer-widget">
					...
					<ul class="contact">
						<li><p><i class="fa fa-map-marker"></i> 123 Street 133/2, Ontario, Canada</p></li>
						<li><p><i class="fa fa-phone"></i> (+88) 111 555 666</p></li>
						<li><p><i class="fa fa-envelope"></i> infolawexamprep@gmail.com</p></li>
						<li><p><i class="fa fa-clock-o"></i> 24x7</p></li>
					</ul>
				</div>
			</div>
		</div>
